...
/***/ function(module, exports, __webpack_require__) {
	...
	var vote_1 = __webpack_require__(159);
	var react_redux_1 = __webpack_require__(173);
	var voteStore_1 = __webpack_require__(163);
	function Hello(name) {
	    console.log("Hello " + name + "!");
	}
	Hello("huy");
	ReactDOM.render(React.createElement(react_redux_1.Provider, {"store": voteStore_1.store}, React.createElement(vote_1.VoteProvider, {"winner": null})), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var immutable_1 = __webpack_require__(160);
	var React = __webpack_require__(1);
	var winner_1 = __webpack_require__(161);
	var voting_1 = __webpack_require__(162);
	var react_redux_1 = __webpack_require__(173);
	var voteStore_1 = __webpack_require__(163);
	var pair = immutable_1.List.of('Trainspotting', '28 Days Later', "mom");
	var Vote = (function (_super) {
	    ...
	    Vote.prototype.render = function () {
	        return (React.createElement("div", null, this.props.winner ?
	            React.createElement(winner_1.Winner, {"winner": this.props.winner}) :
	            React.createElement(voting_1.Voting, {"pair": pair})));
	    };
	    return Vote;
	})(React.Component);
	exports.Vote = Vote;
	exports.VoteProvider = react_redux_1.connect(function (state) {
	    var winner = null;
	    var votedState = voteStore_1.VoteStoreProvider.voted;
	    votedState(state).forEach(function (value, key) {
	        console.log(key);
	        if (value) {
	            winner = key;
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Winner = (function (_super) {
	    ...
	    Winner.prototype.render = function () {
	        return (React.createElement("div", {"className": "winner"}, "Winner is ", this.props.winner, "!"));
	    };
	    return Winner;
	})(React.Component);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Voting = (function (_super) {
	    ...
	    Voting.prototype.getPair = function () {
	        return this.props.pair || immutable_1.List.of();
	    };
	    Voting.prototype.vote = function (entry) {
	        alert("voted " + entry);
	        voteStore_1.store.dispatch({
	            type: "VOTE",
	            voted: immutable_1.Map().set(entry, true)
	        });
	    };
	    Voting.prototype.render = function () {
	        var _this = this;
	        return (React.createElement("div", null, React.createElement("div", {"className": "voting"}, this.getPair().map(function (entry) {
	            return React.createElement("button", {"key": entry, "onClick": function () { return _this.vote(entry); }}, React.createElement("h1", null, entry));
	        }))));
	    };
	    return Voting;
	})(React.Component);
...
/***/ function(module, exports, __webpack_require__) {
	...
	///<reference path="../typings/immutable/immutable.d.ts"/>
	var immutable_1 = __webpack_require__(160);
	var Redux = __webpack_require__(164);
	var _storeState = immutable_1.Map();
	var storeState = _storeState
	    .set("voted", immutable_1.Map({ "voted": true }));
	var VoteStoreProvider = (function () {
	    function VoteStoreProvider() {
	    }
	    VoteStoreProvider.voted = function (state) {
	        if (!state) {
	            return immutable_1.Map();
	        }
	        return (state.get("voted"));
	    };
	    return VoteStoreProvider;
	})();
	exports.VoteStoreProvider = VoteStoreProvider;
	exports.store = Redux.createStore(function (state, action) {
	    if (state === void 0) { state = storeState; }
	    switch (action.type) {
	        case "VOTE":
	            var _state = state.update("voted", function (voted) {
