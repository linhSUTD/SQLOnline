...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(vote_1.Vote, {"winner": "Trainspotting"}), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var pair = immutable_1.List.of('Trainspotting', '28 Days Later');
	var Vote = (function (_super) {
	    ...
	    Vote.prototype.render = function () {
	        return (React.createElement("div", null, this.props.winner ?
	            ...
	            React.createElement(voting_1.Voting, {"hasvoted": this.props.winner, "pair": pair})));
	    };
	    return Vote;
	})(React.Component);
	exports.Vote = Vote;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Voting = (function (_super) {
	    ...
	    Voting.prototype.isDisabled = function () {
	        return this.props.pair.indexOf(this.props.hasvoted) >= 0;
	    };
	    Voting.prototype.hasVotedFor = function (entry) {
	    ...
	    Voting.prototype.render = function () {
	        ...
	        return (React.createElement("div", null, React.createElement("div", {"className": "voting"}, this.getPair().map(function (entry) {
	            return React.createElement("button", {"key": entry, "onClick": function () { return _this.vote(entry); }, "disabled": _this.isDisabled()}, React.createElement("h1", null, entry), _this.hasVotedFor(entry) ? React.createElement("div", {"className": "label"}, "Voted") : null);
	        }))));
	    };
	    return Voting;
	})(React.Component);
